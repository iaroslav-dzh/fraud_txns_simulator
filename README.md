...
5. Загрузил данные в `Power BI`, создал модель данных и на ее основании дашборд с информацией о транзакциях. Создал визуализации, применил условное форматирование, создал `DAX` меры. Видео демонстрация на 2,5 минуты: **[Ссылка](https://rutube.ru/video/private/28d85101f267427e568ed850d8db0878/?p=vjJbbxQMAL7NUtrge6UC2g)**
