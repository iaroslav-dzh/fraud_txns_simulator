...
Более развернутое описание проекта **[по ссылке](https://iaroslav-dzh.github.io/fraud_txns_simulator/index.html)** - это сайт проекта. Там более подробное описание в целом и подробное описание генератора транзакций по разделам.  
